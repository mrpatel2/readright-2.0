...
void main() {
  final pool = [
    WordItem(category: 'Dolch', word: 'all', exampleSentence: 'All the kids are here.'),
    WordItem(category: 'Dolch', word: 'am', exampleSentence: 'I am ready.'),
    WordItem(category: 'Dolch', word: 'are', exampleSentence: 'We are happy.'),
    WordItem(category: 'Dolch', word: 'brown', exampleSentence: 'The dog is brown.'),
  ];
  ...
  test('round options never exceed requested count and never include duplicates', () {
  ...
  test('sentence has the target word replaced with a blank, case-insensitively', () {
  ...
  test('falls back to appending a blank when the word is not found verbatim in the sentence', () {
    final oddball = WordItem(category: 'Dolch', word: 'zzz', exampleSentence: 'No match here.');
